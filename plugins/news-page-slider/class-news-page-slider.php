...
//		wp_enqueue_script($this->plugin_slug . '-sly', plugins_url('js/sly.min.js', __FILE__), array('jquery'), $this->version);
	...
	public function news_page_slider_init($atts, $content = null) {
		...
		$number = (isset($slider['posts'])) ? $slider['posts'] * 4 : 4;
		...
		if ($query == false) {
			...
			$args = array(
				'post_type' => array('post' /* , ' my-product', 'product' */),
				'orderby' => $sort,
				'order' => $order,
