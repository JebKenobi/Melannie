...
else
{
	...
	add_action('wp_head', 'mvb_wp_head');
	
	function mvb_wp_head() {
		global $post;
		...
		if (is_single() || is_page() || is_404()) {
			if (!empty($post->ID)) {
				...
				if (!empty($row_navigation)) {
					echo '<script type="text/javascript">var mvb_row_navigation = true;</script>';
				} else {
					echo '<script type="text/javascript">var mvb_row_navigation = false;</script>';
				}
				
				if (!empty($scroll_navigation)) {
					wp_dequeue_script('smooth-scroll');
					echo '<script type="text/javascript">var mvb_scroll_navigation = true;</script>';
				} else {
					echo '<script type="text/javascript">var mvb_scroll_navigation = false;</script>';
				}
			}
		}
	}
