...
if (!function_exists('dfd_kadabra_scripts')) {
	...
	function dfd_kadabra_scripts() {
		...
		wp_register_script('jCarouselSwipe', get_template_directory_uri() . '/assets/js/jCarouselSwipe.min.js', array('jcarousel', 'hammer', 'crum_foundation'), null, false);
		...
		wp_register_script('custom-share', get_template_directory_uri() . '/assets/js/jquery.sharrre-1.3.4.min.js', array('jquery'), '1.3.4', true);
...
//		wp_register_script('colpick', get_template_directory_uri() . '/stylechanges/colpick/js/colpick.js', false, null, true);
		...
		// Audioplayer
		wp_register_script('js-audio', get_template_directory_uri().'/assets/js/audioplayer.js', false, null, false);
		wp_register_script('js-audio-run', get_template_directory_uri().'/assets/js/audioplayer.run.js', false, null, false);
			...
			switch($curr_page_template) {
				...
				case 'tmp-portfolio-masonry-1-bordered.php':
					if (DfdThemeSettings::get("folio_sorting")) {
						...
						wp_enqueue_script('masonry');
						wp_enqueue_script('dfd-masonry-enable');
					}
					break;
